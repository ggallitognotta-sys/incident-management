...
public class ProcessorServiceHandler implements EventHandler {
    ...
    /*
     * Cambia l'urgenza di un incidente in "high" se il titolo contiene la parola "urgent"
     */
    ...
    /*
     * Handler per evitare l'aggiornamento di un incidente "closed"
     */
    @Before(event = CqnService.EVENT_UPDATE)
    public void ensureNoUpdateOnClosedIncidents(Incidents incident) {
        Incidents in = db.run(Select.from(Incidents_.class)
